...
export class ControlUnit {
  public generate(instruction: any): ControlSignals {
    ...
    switch (type) {
      case "R":
        const funct7 = decoded.funct7();
        signals.ru_wr = true;
        signals.alu_op = funct7[6]! + funct7[1]! + decoded.funct3();
        break;
      ...
      case "I":
        ...
        if (decoded.isIArithmetic()) {
          const MSBaluOp = decoded.isILogical()
            ? decoded.immFunct7()[1]!
            : "0";
          signals.alu_op = "0" + MSBaluOp + decoded.funct3();
        } else if (decoded.isILoad()) {
          signals.alu_op = "00000";
          signals.ru_data_wr_src = "01";
        } else if (decoded.isIJump()) {
          signals.alu_op = "00000";
      ...
      case "B":
        ...
        signals.alub_src = true;
        signals.br_op = "01" + decoded.funct3();
        signals.imm_src = "101";
        signals.ru_data_wr_src = "XX";
        break;
